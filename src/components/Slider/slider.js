...
import Slide_1 from '../../img/img1.png';
import Slide_2 from '../../img/img2.png';
import Slide_3 from '../../img/img3.png';
import Slide_4 from '../../img/img4.png';
...
class Slider extends Component{
    constructor(props){
        ...
        this.intervalBetweensSlides = this.intervalBetweensSlides.bind(this);
        this.toggleAutoPlay = this.toggleAutoPlay.bind(this);
        this.nextOne  = this.nextOne.bind(this);
        this.prevOne  = this.prevOne.bind(this);
    }
    componentDidMount(){
        this.interval = setInterval(()=> this.intervalBetweensSlides(), 3000);
    }
    componentWillUnmount(){
        clearInterval(this.interval);
    }
    intervalBetweensSlides(){
